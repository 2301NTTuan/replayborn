...
| --- | --- | --- | --- |
| `assets/original_v1/astria_run_v1.png` | Astria, urban-techwear circuit runner | `exec-175a0bf5-beda-4cb2-ac60-80125d126840.png` | No franchise/artist imitation; no white hair, staff, fantasy armor, gold filigree, logos, or known-character likeness. |
