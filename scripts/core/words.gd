...
"help_body": ["Chạm và rê ngón tay ở bất kỳ đâu trong đấu trường để di chuyển. Astria tự bắn mục tiêu gần nhất. Chạm nút tạm dừng ở góc trên để mở menu trận.\n\nMỗi 15 giây tạo một Echo lặp lại đường đi và các phát bắn đã ghi. Tối đa bốn Echo cùng chiến đấu; bản ghi thứ năm thay Echo cũ nhất. Echo có HP và có thể bị hạ gục.\n\nNeon Ruins có 5 level, mỗi level kéo dài 2 phút rồi xuất hiện Boss. Hạ Boss để sang level tiếp theo; hạ Boss thứ năm để thắng trận.", "Touch and drag anywhere in the arena to move. Astria automatically fires at the nearest target. Tap the pause button in the top corner to open the run menu.\n\nEvery 15 seconds, an Echo replays your recorded movement and shots. Up to four Echoes fight together; the fifth tape replaces the oldest Echo. Echoes have HP and can be defeated.\n\nNeon Ruins has 5 levels. Each level lasts two minutes before its Boss arrives. Defeat each Boss to advance, then defeat the fifth to win."],
...
"character_menu": ["CHỌN NHÂN VẬT", "CHOOSE CHARACTER"],
"map_menu": ["CHỌN BẢN ĐỒ", "CHOOSE MAP"],
"loadout": ["MẶC TRANG BỊ", "LOADOUT"],
"shop": ["CỬA HÀNG & RƯƠNG", "SHOP & CHESTS"],
"missions": ["NHIỆM VỤ", "MISSIONS"],
"selected_character": ["Nhân vật đang chọn", "Selected character"],
"selected_map": ["Bản đồ đang chọn", "Selected map"],
