...
"help_body": ["Chạm và rê ngón tay ở bất kỳ đâu trong đấu trường để di chuyển. Nhân vật tự bắn mục tiêu gần nhất. Chạm nút tạm dừng ở góc trên để mở menu trận.\n\nMỗi 15 giây tạo một bản sao lặp lại đường đi và các phát bắn của bạn. Tối đa 4 bản sao; bản mới thay bản cũ nhất. Bản sao cũng có HP và có thể bị hạ gục.\n\nMỗi map có 5 mức, mỗi mức gồm 3 loại quái và một Boss riêng. Boss sau mạnh hơn và có nhiều kỹ năng. Né đường lao tím và đạn đỏ.", "Touch and drag anywhere in the arena to move. Your character automatically fires at the nearest target. Tap the pause button in the top corner to open the run menu.\n\nEvery 15 seconds, an Echo replays your movement and shots. You can have up to 4 Echoes; the newest replaces the oldest. Echoes have HP and can be defeated.\n\nEvery map has 5 levels, each with three enemy types and a distinct Boss. Later bosses are stronger and use several skills. Dodge purple charge lines and red bullets."],
