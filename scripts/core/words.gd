...
"help_body": ["Chạm và rê ngón tay ở bất kỳ đâu trong đấu trường để di chuyển. Nhân vật tự bắn mục tiêu gần nhất. Chạm nút tạm dừng ở góc trên để mở menu trận.\n\nMỗi 15 giây tạo một bản sao lặp lại đường đi và các phát bắn của bạn. Chỉ có 1 bản sao; bản ghi mới thay bản cũ. Bản sao cũng có HP và có thể bị hạ gục.\n\nMỗi level kéo dài 5 phút: 2 phút 30 giây quái thường, 2 phút 30 giây quái khó, sau đó là Boss riêng. Hạ Boss để sang level tiếp theo.", "Touch and drag anywhere in the arena to move. Your character automatically fires at the nearest target. Tap the pause button in the top corner to open the run menu.\n\nEvery 15 seconds, an Echo replays your movement and shots. Only 1 Echo is active; a new recording replaces the old one. Echoes have HP and can be defeated.\n\nEach level lasts 5 minutes: 2:30 of normal enemies, 2:30 of harder enemies, then a distinct Boss. Defeat the Boss to advance."],
