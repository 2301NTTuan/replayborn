...
func _ready() -> void:
	for key in ["shot", "hit", "hurt", "circuit", "shift", "perfect_dodge", "overdrive", "boss_alert", "level_up", "upgrade", "win", "lose", "secondary_boomerang", "secondary_orbit", "secondary_drone", "secondary_mine", "secondary_beam"]:
		var params: Array = {
			"shot": [850.0, 300.0, 0.055], "hit": [220.0, 90.0, 0.06],
			"hurt": [170.0, 45.0, 0.22], "circuit": [330.0, 880.0, 0.3], "shift": [240.0, 1180.0, 0.16], "perfect_dodge": [760.0, 1480.0, 0.18], "overdrive": [180.0, 960.0, 0.52], "boss_alert": [90.0, 310.0, 0.62],
