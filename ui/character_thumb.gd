...
func _draw() -> void:
    ...
    draw_string(ThemeDB.fallback_font, Vector2(215, 154), "ĐANG CHỌN / SELECTED" if selected else "Chạm để chọn / Tap to select", HORIZONTAL_ALIGNMENT_LEFT, -1, 20, Color("a9bfd4"))
